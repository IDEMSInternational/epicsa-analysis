...
chirts_zambia_moorings <- full_join(chirts_tmax, chirts_tmin, by = c("station", "date")) 

chirts_zambia <- readRDS(here("data", "satellite", "zambia_chirts.RDS")) %>%
  rbind(chirts_zambia_moorings)
